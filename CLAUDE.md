# CLAUDE.md — Timefold Solver Employee Scheduling (Java/Quarkus)

> You are helping build an employee scheduling application using **Timefold Solver**
...
> When unsure about a pattern, `cat` the ground truth examples in `timefold-scheduling/examples/` to verify.
...
1. **First**, `cat` the employee scheduling example's `pom.xml` and `application.properties` to see the real structure:
   - `cat timefold-scheduling/examples/employee-scheduling/pom.xml`
   - `cat timefold-scheduling/examples/employee-scheduling/src/main/resources/application.properties`
2. Copy `docs/timefold-reference/pom-template.xml` to `pom.xml`.
...
Read these BEFORE writing code. They are in `docs/timefold-reference/`:
...
| `timefold-scheduling/examples/employee-scheduling/` | Verify any pattern against working code (primary ground truth) | — |
| `timefold-scheduling/examples/school-timetabling/` | Simpler reference for basic patterns, multi-variable entities | — |
| `timefold-scheduling/examples/flight-crew-scheduling/` | Rest time constraints, home airport, date-spanning shifts | — |
| `timefold-scheduling/examples/conference-scheduling/` | Multi-variable, speaker conflicts, preference constraints | — |
| `timefold-scheduling/examples/meeting-scheduling/` | Attendee conflicts, time grain modeling | — |
| `timefold-scheduling/examples/bed-allocation/` | Overconstrained planning, date-range overlaps | — |
| `timefold-scheduling/examples/task-assigning/` | Skill matching, priority weights, affinity | — |
...
Seven complete working quickstarts are in `timefold-scheduling/examples/`. **When unsure about annotation placement, domain modeling, constraint syntax, or REST wiring — `cat` the relevant file below before generating code.** These are canonical Timefold patterns.
...
| What | Path |
|---|---|
| Planning entity | `timefold-scheduling/examples/employee-scheduling/src/main/java/org/acme/employeescheduling/domain/Shift.java` |
| Problem facts | `timefold-scheduling/examples/employee-scheduling/src/main/java/org/acme/employeescheduling/domain/Employee.java` |
| Availability fact | `timefold-scheduling/examples/employee-scheduling/src/main/java/org/acme/employeescheduling/domain/Availability.java` |
| Planning solution | `timefold-scheduling/examples/employee-scheduling/src/main/java/org/acme/employeescheduling/domain/EmployeeSchedule.java` |
| ConstraintProvider | `timefold-scheduling/examples/employee-scheduling/src/main/java/org/acme/employeescheduling/solver/EmployeeSchedulingConstraintProvider.java` |
| REST endpoint | `timefold-scheduling/examples/employee-scheduling/src/main/java/org/acme/employeescheduling/rest/EmployeeScheduleResource.java` |
| Constraint tests | `timefold-scheduling/examples/employee-scheduling/src/test/java/org/acme/employeescheduling/solver/EmployeeSchedulingConstraintProviderTest.java` |
| application.properties | `timefold-scheduling/examples/employee-scheduling/src/main/resources/application.properties` |
| pom.xml | `timefold-scheduling/examples/employee-scheduling/pom.xml` |
...
| What | Path |
|---|---|
| Planning entity | `timefold-scheduling/examples/school-timetabling/src/main/java/org/acme/schooltimetabling/domain/Lesson.java` |
| Problem facts | `timefold-scheduling/examples/school-timetabling/src/main/java/org/acme/schooltimetabling/domain/Room.java` |
| Problem facts | `timefold-scheduling/examples/school-timetabling/src/main/java/org/acme/schooltimetabling/domain/Timeslot.java` |
| Planning solution | `timefold-scheduling/examples/school-timetabling/src/main/java/org/acme/schooltimetabling/domain/Timetable.java` |
| ConstraintProvider | `timefold-scheduling/examples/school-timetabling/src/main/java/org/acme/schooltimetabling/solver/TimetableConstraintProvider.java` |
| REST endpoint | `timefold-scheduling/examples/school-timetabling/src/main/java/org/acme/schooltimetabling/rest/TimetableResource.java` |
| Constraint tests | `timefold-scheduling/examples/school-timetabling/src/test/java/org/acme/schooltimetabling/solver/TimetableConstraintProviderTest.java` |
...
| What | Path |
|---|---|
| Planning entity | `timefold-scheduling/examples/flight-crew-scheduling/flight-crew-scheduling/src/main/java/org/acme/flighcrewscheduling/domain/FlightAssignment.java` |
| Problem facts | `timefold-scheduling/examples/flight-crew-scheduling/flight-crew-scheduling/src/main/java/org/acme/flighcrewscheduling/domain/Flight.java` |
| Problem facts | `timefold-scheduling/examples/flight-crew-scheduling/flight-crew-scheduling/src/main/java/org/acme/flighcrewscheduling/domain/Employee.java` |
| Planning solution | `timefold-scheduling/examples/flight-crew-scheduling/flight-crew-scheduling/src/main/java/org/acme/flighcrewscheduling/domain/FlightCrewSchedule.java` |
| ConstraintProvider | `timefold-scheduling/examples/flight-crew-scheduling/flight-crew-scheduling/src/main/java/org/acme/flighcrewscheduling/solver/FlightCrewSchedulingConstraintProvider.java` |
| REST endpoint | `timefold-scheduling/examples/flight-crew-scheduling/flight-crew-scheduling/src/main/java/org/acme/flighcrewscheduling/rest/FlightCrewScheduleResource.java` |
...
| What | Path |
|---|---|
| Planning entity | `timefold-scheduling/examples/conference-scheduling/src/main/java/org/acme/conferencescheduling/domain/Talk.java` |
| Problem facts | `timefold-scheduling/examples/conference-scheduling/src/main/java/org/acme/conferencescheduling/domain/Room.java` |
| Problem facts | `timefold-scheduling/examples/conference-scheduling/src/main/java/org/acme/conferencescheduling/domain/Timeslot.java` |
| Problem facts | `timefold-scheduling/examples/conference-scheduling/src/main/java/org/acme/conferencescheduling/domain/Speaker.java` |
| Planning solution | `timefold-scheduling/examples/conference-scheduling/src/main/java/org/acme/conferencescheduling/domain/ConferenceSchedule.java` |
| ConstraintProvider | `timefold-scheduling/examples/conference-scheduling/src/main/java/org/acme/conferencescheduling/solver/ConferenceSchedulingConstraintProvider.java` |
...
| What | Path |
|---|---|
| Planning entity | `timefold-scheduling/examples/meeting-scheduling/src/main/java/org/acme/meetingschedule/domain/MeetingAssignment.java` |
| Problem facts | `timefold-scheduling/examples/meeting-scheduling/src/main/java/org/acme/meetingschedule/domain/Meeting.java` |
| Problem facts | `timefold-scheduling/examples/meeting-scheduling/src/main/java/org/acme/meetingschedule/domain/Room.java` |
| Problem facts | `timefold-scheduling/examples/meeting-scheduling/src/main/java/org/acme/meetingschedule/domain/TimeGrain.java` |
| Planning solution | `timefold-scheduling/examples/meeting-scheduling/src/main/java/org/acme/meetingschedule/domain/MeetingSchedule.java` |
| ConstraintProvider | `timefold-scheduling/examples/meeting-scheduling/src/main/java/org/acme/meetingschedule/solver/MeetingSchedulingConstraintProvider.java` |
...
| What | Path |
|---|---|
| Planning entity | `timefold-scheduling/examples/bed-allocation/src/main/java/org/acme/bedallocation/domain/Stay.java` |
| Problem facts | `timefold-scheduling/examples/bed-allocation/src/main/java/org/acme/bedallocation/domain/Bed.java` |
| Problem facts | `timefold-scheduling/examples/bed-allocation/src/main/java/org/acme/bedallocation/domain/Room.java` |
| Problem facts | `timefold-scheduling/examples/bed-allocation/src/main/java/org/acme/bedallocation/domain/Department.java` |
| Planning solution | `timefold-scheduling/examples/bed-allocation/src/main/java/org/acme/bedallocation/domain/BedPlan.java` |
| ConstraintProvider | `timefold-scheduling/examples/bed-allocation/src/main/java/org/acme/bedallocation/solver/BedAllocationConstraintProvider.java` |
...
| What | Path |
|---|---|
| Planning entities | `timefold-scheduling/examples/task-assigning/src/main/java/org/acme/taskassigning/domain/Employee.java` (chain anchor) |
| Planning entities | `timefold-scheduling/examples/task-assigning/src/main/java/org/acme/taskassigning/domain/Task.java` (chained entity) |
| Problem facts | `timefold-scheduling/examples/task-assigning/src/main/java/org/acme/taskassigning/domain/Customer.java` |
| Problem facts | `timefold-scheduling/examples/task-assigning/src/main/java/org/acme/taskassigning/domain/TaskType.java` |
| Planning solution | `timefold-scheduling/examples/task-assigning/src/main/java/org/acme/taskassigning/domain/TaskAssigningSolution.java` |
| ConstraintProvider | `timefold-scheduling/examples/task-assigning/src/main/java/org/acme/taskassigning/solver/TaskAssigningConstraintProvider.java` |
...
| pom.xml / dependencies | `cat timefold-scheduling/examples/employee-scheduling/pom.xml` |
...
| Limit field/resource capacity | `groupBy()` + `sum()` of sizes | `hockey-scheduler` | `ConstraintCollectors.sum()` |
...
cd timefold-scheduling/examples/employee-scheduling
mvn quarkus:dev
...
cd timefold-scheduling/examples
...
diff -u my-file.java timefold-scheduling/examples/employee-scheduling/.../TheirFile.java
```
...
**Fix:** Check `pom.xml` has `quarkus-timefold-solver` dependency and versions match (Timefold 1.30.0 → Quarkus 3.30.6)
...
- `timefold-scheduling/examples/` — 7 working quickstarts (ground truth): employee-scheduling, school-timetabling, flight-crew-scheduling, conference-scheduling, meeting-scheduling, bed-allocation, task-assigning
- `docs/timefold-reference/` — condensed reference guides
